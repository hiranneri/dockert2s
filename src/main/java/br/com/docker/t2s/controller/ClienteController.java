...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponseDTO> criarCliente(@RequestBody @Valid ClienteRequestDTO clienteRequestDTO){
        return new ResponseEntity<>(clienteService.criar(clienteRequestDTO), HttpStatus.CREATED);
    }
    ...
    @GetMapping("/search")
    public ResponseEntity<ClienteResponseDTO> buscarCliente(@RequestParam String nome){
